...
// import { Clipboard, commands, env, ExtensionContext, Uri, ViewColumn, WebviewPanel, window, workspace, Disposable } from 'vscode';
...
//     public async render(response: object, column: ViewColumn) {
//         let panel: WebviewPanel;
//         if (ext.settings.showResponseInDifferentTab || this.panels.length === 0) {
//             panel = window.createWebviewPanel(
//                 this.viewType,
//                 this.getTitle(response),
//                 { viewColumn: column, preserveFocus: !ext.settings.previewResponsePanelTakeFocus },
//                 {
...
//         this.setPrviewActiveContext(ext.settings.previewResponsePanelTakeFocus);

//         panel.reveal(column, !ext.settings.previewResponsePanelTakeFocus);
...
//         const prefix = (false && response.request.name) || 'Response';
...
// //             if (true &&
// //                 response.bodySizeInBytes > 5 * 1024 * 1024) {
...
//     //     return [
//     //         '<style>',
//     //         (ext.settings.fontFamily || this.settings.fontSize || this.settings.fontWeight ? [
//     //             'code {',
